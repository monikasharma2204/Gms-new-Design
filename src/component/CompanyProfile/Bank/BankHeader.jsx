...
const BankHeader = ({ selectedData, isEditing, onEditToggle }) => {
  const fillColor = selectedData ? "#FFF" : "#57646E";
  return (
    <>
      <Box
        sx={{
      ...
      >
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: "12px" }}>
          <Box>
          <Link to="/stone-master/shape/add/" >
          <Button
                sx={{
                  textTransform: "none",
                  height: "35px",
          ...
          <Box>
            <Button
            onClick={selectedData ? onEditToggle : undefined}
              sx={{
                textTransform: "none",
                height: "35px",
                width: "84px",
                ...
                gap: "8px",
                marginRight: "12px",
                backgroundColor: selectedData ? "#C6A969" : "#E6E6E6",
                "&:hover": {
                  backgroundColor: selectedData ? "#C6A969" : "#E6E6E6",
                },
              }}
