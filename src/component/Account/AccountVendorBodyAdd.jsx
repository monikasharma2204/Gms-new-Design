...
const AccountVendorBodyAdd = ({
  ...
  useEffect(() => {
    ...
    // Don't override editStatus here - let the parent page control it
    // if (action === "edit") {
    //   setEditStatus(true);
    // } else {
    //   setEditStatus(false);
              ...
              >
                <Box sx={{ display: "flex" }}>
                  ...
                  >
                    {/* <IOSSwitch
                      checked={
                        vendorListAddress.length > 0 &&
                        vendorListAddress[0].status === "active"
                          ? true
                          : false
                      }
