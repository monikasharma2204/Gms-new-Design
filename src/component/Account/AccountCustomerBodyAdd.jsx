...
const AccountVendorBodyAdd = ({
  ...
  const [fieldErrors] = useRecoilState(vendorFieldErrorsState);
                  ...
                  {vendorListAddress?.map((v, index) => (
                    <Box key={index} mb={2}>
                      ...
                      <CompanyName
                        ...
                        error={!!fieldErrors[`invoice_address_${index}_company_name`]}
                        helperText={fieldErrors[`invoice_address_${index}_company_name`]}
                      />
                      <TaxID
                        value={v.tax_id}
                        onChange={(event) => {
                        ...
                        error={!!fieldErrors[`invoice_address_${index}_tax_id`]}
                        helperText={fieldErrors[`invoice_address_${index}_tax_id`]}
                      />
                      <Address
                        value={v.address}
                        onChange={(event) => {
                        ...
                        error={!!fieldErrors[`invoice_address_${index}_address`]}
                        helperText={fieldErrors[`invoice_address_${index}_address`]}
                      />
                      <Country
                        ...
                        error={!!fieldErrors[`invoice_address_${index}_country`]}
                        helperText={fieldErrors[`invoice_address_${index}_country`]}
                      />
                      <StateProvince
                        value={v.state}
                        onChange={(newValue) => {
                        ...
                        error={!!fieldErrors[`invoice_address_${index}_state`]}
                        helperText={fieldErrors[`invoice_address_${index}_state`]}
                      />
                      ...
                      <City
                        ...
                        error={!!fieldErrors[`invoice_address_${index}_city`]}
                        helperText={fieldErrors[`invoice_address_${index}_city`]}
                      />
                      ...
                      <PostCode
                        ...
                        error={!!fieldErrors[`invoice_address_${index}_postcode`]}
                        helperText={fieldErrors[`invoice_address_${index}_postcode`]}
                      />
                    </Box>
                  ))}
                </Box>
